                        ...
                        $('#{{ $name }}').select2({
                            ...
                            ajax: {
                                ...
                                data: function(params) {
                                    var value = $("input[type=radio][name={{ $form['radioparent'] }}]:checked").val();
...
<div class='form-group {{ $header_group_class }} {{ $errors->first($name) ? 'has-error' : '' }}' id='form-group-{{ $name }}' style="{{ @$form['style'] }}">
    @if ($readonly)
        ...
        <li class="list-group-item {{ $col_width ?: 'col-sm-10' }}">
            <strong><i class="fa-solid fa-phone" style="color: OrangeRed;"></i>  {{ $form['label'] }} :</strong>

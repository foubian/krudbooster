                ...
                @if ($form['datatable_ajax'] == false)
                    ...
                    @if ($readonly)
                        ...
                        foreach ($result as $r) {
                            ...
                            $selected = $option_value == $value ? $option_label : '';
                        }
                        ?>
                        <li class="list-group-item">
                            @if ($selected == '')
                    ...
                    @else
                        <select {{ $required }} {{ $readonly }} {{ $disabled }} {{ $form['relationship_table'] ? 'multiple="multiple"' : '' }} {!! $placeholder !!}
                            class='form-control' id="{{ $name }}" name="{{ $name }}{{ $form['relationship_table'] ? '[]' : '' }}" style='width:100%'>

    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
                ...
                <ul class="treeview-menu">
                    ...
                    <li data-id='{{ $child->id }}'
                        ...
                        <a href='{{ $child->is_broken ? "javascript:alert('" . cbLang('controller_route_404') . "')" : $child->url }}'
                            ...
                            <i class='{{ $child->icon }}'></i> <span>{{ $child->name_ar }}</span>
                        </a>
                    </li>
                    @endforeach
                </ul>
            ...
            <li class='treeview'>
                <a href='#'>
                    <i class='fa fa-key'></i>
                    <span>{{ cbLang('Privileges_Roles') }}</span>
                </a>
                <ul class='treeview-menu'>
                    <li
            ...
            <li class='treeview'>
                <a href='#'>
                    ...
                    <span>{{ cbLang('Users_Management') }}</span>
                </a>
                <ul class='treeview-menu'>
            ...
            <li class='treeview'>
                <a href='#'>
                    <i class='fa fa-th'></i>
                    <span>{{ cbLang('Module_Generator') }}</span>
            ...
            <li class='treeview'>
                <a href='#'>
                    ...
                    <span>{{ cbLang('Statistic_Builder') }}</span>
                </a>
                <ul class='treeview-menu'>
                    <li
            ...
            <li class='treeview'>
                <a href='#'>
                    ...
                    <span>{{ cbLang('API_Generator') }}</span>
                </a>
                <ul class='treeview-menu'>
                    <li
            ...
            <li class='treeview'>
                <a href='#'>
                    ...
                    <span>{{ cbLang('Email_Templates') }}</span>
                </a>
                <ul class='treeview-menu'>
                    <li

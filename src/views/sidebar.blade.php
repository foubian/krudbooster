...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @if ($dashboard)
                <li class="treeview" data-id='{{ $dashboard->id }}'
                    ...
                    <a href='{{ $menu->is_broken ? "javascript:alert('" . cbLang('controller_route_404') . "')" : $menu->url }}'
                        ...
                        @php
                            ...
                            if (strlen($menu->name) > 12) {
                                $stil = 'padding-right:45px;white-space: normal;line-height:12px';
                            } else {
                                $stil = '';
                            }
                        ...
                        <span style="{{ $stil }}">{{ $menu->name }}</span>
                        @if (!empty($menu->children))
                            <span class="pull-{{ cbLang('right') }}-container">
                                <i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                            </span>
                        @endif
            ...
            @if (CRUDBooster::isSuperadmin())
                ...
                <li class='treeview'>
                    <a href='#'>
                        ...
                        <span
                            style="padding-right:45px;white-space: normal;line-height:12px">{{ cbLang('Privileges_Roles') }}</span>
                ...
                <li class='treeview'>
                    <a href='#'>
                        ...
                        <span
                            style="padding-right:45px;white-space: normal;line-height:12px">{{ cbLang('Users_Management') }}</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                ...
                <li class='treeview'>
                    <a href='#'>
                        <i class='fa fa-th'></i>
                        <span
                            style="padding-right:45px;white-space: normal;line-height:12px">{{ cbLang('Module_Generator') }}</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                    </a>
                ...
                <li class='treeview'>
                    <a href='#'><i class='fa fa-dashboard'></i>
                        <span
                            style="padding-right:45px;white-space: normal;line-height:12px">{{ cbLang('Statistic_Builder') }}</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                    </a>
                ...
                <li class='treeview'>
                    <a href='#'>
                        ...
                        <span
                            style="padding-right:45px;white-space: normal;line-height:12px">{{ cbLang('API_Generator') }}</span>
                        <span class="pull-right-container"><i
                                class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                    </a>
                    <ul class='treeview-menu'>
                        <li
                ...
                <li class='treeview'>
                    <a href='#'><i class='fa fa-envelope'></i><span
                            style="padding-right:45px;white-space: normal;line-height:12px">{{ cbLang('Email_Templates') }}</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                    </a>

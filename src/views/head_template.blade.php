<!-- Bootstrap 3.3.7 -->
<link rel="stylesheet"
    href="{{ asset('vendor/crudbooster/assets/adminlte/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">
<!-- Sweetalert -->
<link rel="stylesheet" href="{{ asset('vendor/crudbooster/assets/sweetalert/dist/sweetalert2.min.css') }}">
<!-- Font Awesome 6 Icons -->
<link href="{{ asset('vendor/crudbooster/assets/adminlte/bower_components/font-awesome6/css/all.min.css') }}"
    rel="stylesheet" />
<!-- Ionicons -->
<link rel="stylesheet"
    href="{{ asset('vendor/crudbooster/assets/adminlte/bower_components/Ionicons/css/ionicons.min.css') }}">
<!-- jvectormap
